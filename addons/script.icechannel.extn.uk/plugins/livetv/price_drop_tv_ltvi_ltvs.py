...
class price_drop_tv(LiveTVIndexer, LiveTVSource):
    implements = [LiveTVIndexer, LiveTVSource]
    
    display_name = "Price Drop TV"
    
    name = 'price_drop_tv'
    
    base_url = 'http://www.price-drop.tv/'
    ...
    def Resolve(self, url):
        ...
        import re
        playable_url = re.search('(rtsp://.+?/pricedroptv.+?)"', content)
        if playable_url:
